...
angular.module('bpmConsoleApp')
    .directive('field', ['$compile', function ($compile) {
        ...
        var templates = {
            ...
            '<input type="text" datepicker-popup="yyyy-MM-dd" class="form-control" id="{{id}}" ng-model="dates[id]" ng-change="parseDate(id, dates[id])" is-open="opened" close-text="Close"  ng-required="required" ng-disabled="readOnly" />' +
